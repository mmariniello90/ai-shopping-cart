    ...
    while True:
        ...
        if "call_id" in response.output[0].to_dict():
            ...
            if tool_call.name == "get_similar_items":
                ...
                console.print(
                    Panel(
                        Markdown(search_response.output_text),
                        title="[deep_sky_blue1]AI[/deep_sky_blue1]",
                        title_align="left",
                        border_style="#12a0d7",
                    )
                ...
                conversation_history.append(
                    {"role": "assistant", "content": search_response.output_text}
                )

            elif tool_call.name == "manage_shopping_cart":
                tool_result = manage_shopping_cart(
                    shopping_cart, args["action"], args["item"]
                )
                ...
                console.print(
                    Panel(
                        Markdown(response_2.output_text),
                        title="[deep_sky_blue1]AI[/deep_sky_blue1]",
                        title_align="left",
                        border_style="#12a0d7",
                    )
                ...
                conversation_history.append(
                    {"role": "assistant", "content": response_2.output_text}
                )
